import ForgeUI, { render, Text, ContextMenu, ModalDialog, useState, Fragment, useProductContext, ButtonSet, Button } from '@forge/ui';
...
const App = () => {
  ...
  return (
    <ModalDialog header="Hello" onClose={() => setOpen(false)}>
      <Text>Hello world! from mark 32345</Text>

      <ButtonSet>
        <Button text="Allow" onClick={testF} />
